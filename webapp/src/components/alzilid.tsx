...
export function AlzilID() {
  ...
  const handleCopy = useCallback(
    (e: React.MouseEvent<HTMLButtonElement>) => {
      e.stopPropagation();
      copyTextToClipboard(metaAddr ? `https://alzil/#${metaAddr}` : '').then(
        () => {
          setCopied(true);
          setTimeout(() => {
            setCopied(false);
  ...
  return (
    <div className="large-block alzil-pane ">
      <div className="alzil-pane-header">
        {opened ? (
          <div className="alzil-pane-header">
          ...
          <div className="alzil-pane-header">
            <div className="header-item" style={{ alignItems: 'center' }}>
              <div className="block-wide">
                ...
                <p className="label alzil-id-contracted">{metaAddr}</p>
              </div>
              <button
      ...
      >
        ...
        <div className="alzil-pane-header buttons">
          <div className="block-wide">
            ...
            <p className="label alzil-id">{metaAddr}</p>
          </div>
        ...
        <div
          className="alzil-pane-header block message"
          style={{
            width: '90%',
